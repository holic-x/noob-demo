...
TEST_F(Exp_01_05_DeleteTest, Correct){
    ...
    */
    ...
    // 全表删除测试：
//    EXPECT_EQ(9,  delete_("delete student"));
//    EXPECT_EQ(0, select("select * from student"));

    // 错误样例测试
//    EXPECT_EQ(0, delete_("delete "));
//    EXPECT_EQ(0, delete_( "delete student where"));
//    EXPECT_EQ(0, delete_( "delete student where 1=1"));
    EXPECT_EQ(0, delete_( "del student where 1=1"));
