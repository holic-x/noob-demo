...
public class RSAUtil {
    ...
    // 填充模式：PKCS1Padding 或者 OAEP (数据加解密交互必须确保使用相同的填充模式)
    private static String RSA_TRANSFORMATION = "RSA/ECB/OAEPWithSHA-256AndMGF1Padding"; // 此处统一使用 OAEP
    ...
    public static void main(String[] args) {
        ...
        try {
            encryptData = RSAUtil.encrypt(businessData, "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEArkjEy+RmX0U/ABg55oU45sxx0jzvRQC2\n" +
        ...
        String decryptData = "";
        try {
            decryptData = RSAUtil.decrypt(encryptData, "MIIEvgIBADANBgkqhkiG9w0BAQEFAASCBKgwggSkAgEAAoIBAQCuSMTL5GZfRT8AGDnmhTjmzHHS\n" +
