...
/**
 * @Title TextWatermarkForImageUtil
 * @Description 给图片添加文字水印工具类
 */
public class TextWatermarkForImageUtil {
    ...
    public static void main(String[] args) {
        ...
        String srcImgPath = sourcePath + "images.jpg"; // images.jpg test.bmp
        // 水印文字
        String logoText = "哈哈哈";
        ...
        // 给图片添加正水印文字
        TextWatermarkForImageUtil.ImageByText(logoText, srcImgPath, targetImgPath1, 0);
        // 给图片添加斜水印文字
        TextWatermarkForImageUtil.ImageByText(logoText, srcImgPath, targetImgPath2, 40);
        TextWatermarkForImageUtil.ImageByText(logoText, srcImgPath, targetImgPath3, -40);
